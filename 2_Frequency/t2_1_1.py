...
def open_excel_keywordlist(file_name,sheet_name,colnum):
	...
	keydic=count_keyword(data) #将列表中各元素存入词典
	return keydic
...
def main():
	keydic=open_excel_keywordlist(r'/Users/jiangruiyin/Desktop/材料1.xlsx',u'2012paper',3)	
	txt_name=('/Users/jiangruiyin/Desktop/期刊频次.txt')
